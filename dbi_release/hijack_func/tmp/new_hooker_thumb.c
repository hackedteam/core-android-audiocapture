...
/*   /\* if( cblk_tmp->filename == 0) { *\/ */
/*   /\*   cblk_tmp->filename = open("/data/local/tmp/log_out" , O_RDWR , S_IRUSR | S_IRGRP | S_IROTH); *\/ */
/*   /\* } *\/ */
...
/*     snprintf(randString, 11, "%d", rand()); */
/*     snprintf(timestamp,  11, "%d", time(NULL)); */

/*     //         Qi-<timestamp>-<id univoco per chiamata>-<canale>.[tmp|boh] */
/*     // length:  2-strlen(timestamp)-strlen(randString)-1.3.1 -  */
/*     // filenameLength including null */
/*     filenameLength = 2 + strlen(timestamp) + strlen(randString) + 1 + 4 + 1 ; */

/*     cblk_tmp->filename = malloc( sizeof(char) *  filenameLength  ); */
/*     snprintf(cblk_tmp->filename, filenameLength, "Qi-%s-%s-l.bin",timestamp, randString ); */
/*     log("filename: %s\n", cblk_tmp->filename); */
    
/*     cblk_tmp->fd = open(cblk_tmp->filename, O_RDWR , S_IRUSR | S_IRGRP | S_IROTH); */
...
/*     cblk_tmp->streamType = 0xffff; // fake value atm */
...
/* 	//log("\t\trolled back: %x\n", lseek(cblk_tmp->filename, 0, SEEK_CUR)); */

/* 	// write the header */
/* 	now = time(NULL); */
/* 	//tt = gettimeofday(&tv,NULL); */
/* 	write(cblk_tmp->fd, &tv.tv_usec , 4); // 1] timestamp */
/* 	write(cblk_tmp->fd, now , 4); // 2] streamType */
/* 	write(cblk_tmp->fd, &cblk_tmp->sampleRate , 4); // 3] sampleRate */
/* 	write(cblk_tmp->fd, &res , 4); // 4] res */
...
void*  startTrack_h(void* a, void* b, void* c, void* d, void* e, void* f, void* g, void* h, void* i, void* j, void* k, void* l, void* m, void* n, void* o, void* p, void* q, void* r, void* s, void* t, void* u, void* w) {
  ...
  h_ptr = (void *) startTrack_hook.orig;
...
void*  stopTrack_h(void* a, void* b, void* c, void* d, void* e, void* f, void* g, void* h, void* i, void* j, void* k, void* l, void* m, void* n, void* o, void* p, void* q, void* r, void* s, void* t, void* u, void* w) {
  ...
  log("enter stop track: %x\n", a);
  

  h_ptr = (void *) stopTrack_hook.orig;
